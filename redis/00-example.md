...
## What's next
Once this works, we move to **Stage 1**.
You will not feel any problem yet — but a problem is hiding in `show()`.
We'll diagnose it together and write `01-*.md` based on what we find.
